...
func TestFormatWordDiff(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:        "German word with ä (a-umlaut)",
			userInput:   "Mädchen",
			correctWord: "Mädchen",
			wantContains: []string{
				"Your input:",
		...
		{
			name:        "German word with ö (o-umlaut)",
			userInput:   "Schön",
			correctWord: "Schön",
			wantContains: []string{
				"Your input:",
		...
		{
			name:        "German word with ü (u-umlaut)",
			userInput:   "Übung",
			correctWord: "Übung",
			wantContains: []string{
				"Your input:",
		...
		{
			name:        "German word with ß (eszett)",
			userInput:   "Straße",
			correctWord: "Straße",
			wantContains: []string{
				"Your input:",
		...
		{
			name:        "missing ß (using ss instead)",
			userInput:   "Strasse",
			correctWord: "Straße",
			wantContains: []string{
				"Strasse",
		...
		{
			name:        "word with multiple umlauts",
			userInput:   "Müller",
			correctWord: "Müller",
			wantContains: []string{
				"Your input:",
